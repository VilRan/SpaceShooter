...
namespace SpaceShooter.Particles
{
    class ExplosionParticle : TimedParticle
    {
            ...
            : base(texture, position, velocity, Color.OrangeRed, 0.7)
        {
            ...
            TimedParticle.Emit(level, position, Color.Red, 0.2, 0.3, 200, 300, 800);
            TimedParticle.Emit(level, position, Color.OrangeRed, 0.2, 0.9, 200, 100, 300);
            TimedParticle.Emit(level, position, Color.Yellow, 0.2, 0.9, 100, 100, 300);
        }
